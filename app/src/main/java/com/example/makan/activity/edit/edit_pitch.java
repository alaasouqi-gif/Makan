...
public class edit_pitch extends AppCompatActivity implements View.OnClickListener {
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull final DataSnapshot snapshot) {
                ...
                price.setText("Price Book 1 hour : " + snapshot.child("subscription type").child("1").getValue() + "");
                price2.setText("Price Book 2 hour : " + snapshot.child("subscription type").child("2").getValue() + "");
                ...
                edit_g adapter = new edit_g(i, edit_pitch.this, i2, serviceId);
        ...
        offer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent;
                intent = new Intent(edit_pitch.this, offers.class);
        ...
        monitor.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent;
                intent = new Intent(edit_pitch.this, list_monitor.class);
                intent.putExtra("sid", serviceId);
                intent.putExtra("type", serviceType);
                startActivity(intent);
            }
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.name:
                builder = new AlertDialog.Builder(edit_pitch.this, R.style.Theme_MaterialComponents_DayNight_Dialog_Alert);
            ...
            case R.id.start_date:
                ...
                timePickerDialog = new TimePickerDialog(edit_pitch.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
            ...
            case R.id.end_date:
                ...
                timePickerDialog2 = new TimePickerDialog(edit_pitch.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
                    public void onTimeSet(TimePicker timePicker, int hourOfDay, int minutes) {
                        String hour;
                        String minute;
            ...
            case R.id.price2:
                ...
                final TextInputEditText price2 = custom.findViewById(R.id.Event_name);
                price2.setHint("Price of 2 Hour");
                price2.setInputType(InputType.TYPE_CLASS_NUMBER | InputType.TYPE_NUMBER_FLAG_DECIMAL); //for decimal numbers
                builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        myRef.child("subscription type").child("2").setValue(price2.getText().toString());
                    }
                });
