...
public class edit_restaurant extends AppCompatActivity implements View.OnClickListener {
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        relativeLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(edit_restaurant.this, menu.class);
        ...
        myRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull final DataSnapshot snapshot) {
                ...
                price.setText("Price Table : " + snapshot.child("price").getValue() + "");
                ...
                edit_g adapter = new edit_g(i, edit_restaurant.this, i2, serviceId);
        ...
        offer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent;
                intent = new Intent(edit_restaurant.this, offers.class);
        ...
        monitor.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent;
                intent = new Intent(edit_restaurant.this, list_monitor.class);
                intent.putExtra("sid", serviceId);
                intent.putExtra("type", serviceType);
                startActivity(intent);
            }
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.name:
                builder = new AlertDialog.Builder(edit_restaurant.this, R.style.Theme_MaterialComponents_DayNight_Dialog_Alert);
            ...
            case R.id.categories:
                ...
                type_of_event.setAdapter(adapter);
                type_of_event.setHint("Type Of Restaurant");
                builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
            ...
            case R.id.start_date:
                ...
                timePickerDialog = new TimePickerDialog(edit_restaurant.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
            ...
            case R.id.end_date:
                ...
                timePickerDialog2 = new TimePickerDialog(edit_restaurant.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
                    public void onTimeSet(TimePicker timePicker, int hourOfDay, int minutes) {
                        String hour;
                        String minute;
