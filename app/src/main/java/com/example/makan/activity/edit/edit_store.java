...
public class edit_store extends AppCompatActivity implements View.OnClickListener {
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        relativeLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(edit_store.this, menu.class);
        ...
        myRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull final DataSnapshot snapshot) {
                ...
                edit_g adapter = new edit_g(i, edit_store.this, i2, serviceId);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.name:
                builder = new AlertDialog.Builder(edit_store.this, R.style.Theme_MaterialComponents_DayNight_Dialog_Alert);
            ...
            case R.id.categories:
                ...
                type_of_event.setAdapter(adapter);
                type_of_event.setHint("Type Of Store");
                builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
            ...
            case R.id.start_date:
                ...
                timePickerDialog = new TimePickerDialog(edit_store.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
            ...
            case R.id.end_date:
                ...
                timePickerDialog2 = new TimePickerDialog(edit_store.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
                    public void onTimeSet(TimePicker timePicker, int hourOfDay, int minutes) {
                        String hour;
                        String minute;
